    ...
    <Container>
      ...
      <main>
        <div className="container">
          <ButtonText to="/" title="Voltar" icon={GoArrowLeft} />
          ...
          <Infos>
            <div className="user-infos">
              <img
                src="https://github.com/andressa-lw.png"
                alt="Foto de usuário"
              />
              <p>Por Andressa Benedette</p>
            </div>
          ...
          <Tags>
            <Tag title="Ficção Científica" key="1" />
            <Tag title="Drama" key="2" />
            <Tag title="Família" key="3" />
          </Tags>
